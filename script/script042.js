...
function man_data(id,n)
{
	...
	{
			let cause="<select class='demote_cause'> <option value='' selected>Cause</option> <option value='book_missing'>Book missing</option> <option value='deactive_card'>Library card issue</option> <option value='damage_lab'>Computer's part damage</option> <option value='others'>Other</option>  </select>";
