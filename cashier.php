	...
	<body>
		<div class="sidebar">
			...
			<ul class="menu-list">
				...
				<li>
					<button class="icon" id="chat">
						<img src="assets/images/print.png" width="25" height="25" alt="print" />
					</button>
				</li>
		...
		<tr class='head'><td>Sl no.</td> <td>Student Name</td> <td>U.Roll</td> <td>Stream</td> <td>Session</td> <td>Status</td><td>Operation</td> <td>Action</td></tr>
		<tbody id="user_table">
			<!-- Add data -->
		</tbody>
		</table>
		...
		<div class="pop_up" id="pop_up">
			...
			<form id="search_pop_up">		
				...
				<tr>
					<td><select name="search_status"><option value="clearance done" selected>Clearance Done</option> <option value="demote by admin">Demoted By admin</option> <option value="forwarding to bank">Forwarding to Bank</option> <option value="transaction complete">Transaction Done</option> </select></td>
		...
		<script type="text/javascript" src="script/script04.js"></script>
		<script>  
